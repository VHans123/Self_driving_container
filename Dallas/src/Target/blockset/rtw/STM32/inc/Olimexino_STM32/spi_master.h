 ...
 */
#define SPI_MASTER_CHANNEL1_PA5_PA6_PA7    (0)        /* SPI channel 1 - D13/D12/D11   */
#define SPI_MASTER_CHANNEL2_PB13_PB14_PB15 (1)        /* SPI channel 2 - D32/D33/D34   */
 ...
 *         value that is scaled of the system clock, which is 72Mhz for this system.
 */
typedef enum
{
  COM_SPEED_36000_KHZ,
