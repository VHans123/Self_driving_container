...
#if !defined ( XCP_BASIC_VERSION_COMMENT ) && defined ( C_COMP_COSMIC_MCS12X_MSCAN12 )
...
*/
#if !defined ( DAQBYTEPTR ) && defined ( XCP_MEMORY_MODEL_PAGED ) && !defined ( XCP_BASIC_VERSION_COMMENT )
  #if defined ( C_COMP_MTRWRKS_MCS12X_MSCAN12 )
    #define DAQBYTEPTR  vuint8 * far
  #endif
  #if defined ( C_COMP_COSMIC_MCS12X_MSCAN12 )
...
#if !defined ( MTABYTEPTR ) && defined ( XCP_MEMORY_MODEL_PAGED ) && !defined ( XCP_BASIC_VERSION_COMMENT )
  #if defined ( C_COMP_MTRWRKS_MCS12X_MSCAN12 )
    #define MTABYTEPTR  vuint8 * far
  #endif
  #if defined ( C_COMP_COSMIC_MCS12X_MSCAN12 )
...
typedef struct tEightByteFieldTag
{
  ...
  vbittype          byte_6  : 8;
  vbittype          byte_7  : 8;
} __attribute__((packed)) tEightByteField;

typedef union {
  tEightByteField   EightByteField;
  vuint8            b[255/kXcpAG];
} __attribute__((packed)) tXcpDtoByteField;

typedef struct {
  tXcpDtoByteField  XcpDtoByteField;
  vuint8            l;
} __attribute__((packed)) tXcpDto;

typedef union {
  /* There might be a loss of up to 3 bytes. */
  tEightByteField   EightByteField;
  vuint16           b[ ((255 + 3) & 0xFFC) / 2  ];
  vuint16           w[ ((255 + 3) & 0xFFC) / 2  ];
  vuint32           dw[ ((255 + 3) & 0xFFC) / 4 ];
} __attribute__((packed)) tXcpCto;
...
} __attribute__((packed)) tXcpDaqList;
...
extern short kXcpStationIdLengthVariable;
...
} __attribute__((packed)) tXcpSegmentInfo;
#endif
...
#if defined ( XCP_ENABLE_MEM_ACCESS_BY_APPL ) && !defined ( XCP_BASIC_VERSION_COMMENT )
...
extern vuint8 gDebugLevel;
 ...
 /* ApplXcpPrint is a macro */
  #else
extern void ApplXcpPrint( MEMORY_ROM vsint8 *str, ... );
  #endif
...
#endif /* !defined ( _XCP_DEFINITIONS_ ) */
