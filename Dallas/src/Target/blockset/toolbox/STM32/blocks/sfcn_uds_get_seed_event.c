/************************************************************************************//**
* file         sfcn_uds_get_seed_event.c
* brief        Level-2 S-Function for the UDS Get Seed event callback.
*
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
...
#define S_FUNCTION_NAME sfcn_uds_get_seed_event
...
#endif
/********************************* end of sfcn_uds_get_seed_event.c ********************/
